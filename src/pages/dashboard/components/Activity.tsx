...
const Activity: React.FC = () => {
  ...
  return (
    <Card className="p-4 w-full flex flex-col shadow-none border-none bg-[#F5F5F7] gap-4">
      <div className="flex justify-between items-center">
        <h2 className="text-base font-[Plus_Jakarta_Sans] font-semibold text-[#141522]">
          Activity
        </h2>
        <Select value={timeRange} onValueChange={setTimeRange}>
          <SelectTrigger className="w-36 shadow-none border-none">
      ...
      <ResponsiveContainer className="w-full flex h-48">
        <LineChart data={data}>
          <XAxis
            dataKey="day"
            axisLine={false}
